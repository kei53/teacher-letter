        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl bg-white p-5 shadow">
            <div className="grid gap-4">
              ...
              <Textarea label="持ち物（改行で区切る）" value={form.items} onChange={(v) => update("items", v)} />
              <Textarea label="注意事項（改行で区切る）" value={form.notes} onChange={(v) => update("notes", v)} />
          ...
          <div className="rounded-2xl bg-white p-5 shadow">
            <h2 className="text-lg font-semibold">プレビュー（これはWordテンプレとは別）</h2>
